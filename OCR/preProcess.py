...
def transformAndSave(image, pageContour):
    ...
    cv2.imwrite("processedImage/resultImage3.jpg", cv2.cvtColor(newImage, cv2.COLOR_BGR2RGB))
...
def preProcess(image_name):
    ...
    img = loadImage(image)
    pageContour = getCountours(img)
    transformAndSave(image, pageContour)
